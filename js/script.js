...
const WeatherSnap = () => {
    const [temperature] = React.useState(N.rand(20, 40));
...
const Reminder = () => {
    return (React.createElement("div", { className: "reminder" },
        ...
        React.createElement("span", { className: "reminder-text" },
            "Ekstra havalı insanlar toplantısı ",
            React.createElement("span", { className: "reminder-time" }, "10:30"))));
};
const Time = () => {
...
const Pin = () => {
    ...
    const getCancelText = () => {
        return (React.createElement("span", { id: "app-pin-cancel-text", onClick: handleOnCancel }, "İptal"));
    };
    const getErrorText = () => {
        if (userStatus === UserStatus.LogInError) {
            return (React.createElement("span", { id: "app-pin-error-text" }, "Yanlış Şifre"));
        }
    };
...
const Weather = () => {
    ...
    return (React.createElement(MenuSection, { icon: "fa-solid fa-sun", id: "weather-section", scrollable: true, title: "Dışarda hava nasıl?" }, getDays()));
};
const Tools = () => {
    const getTools = () => {
        return [{
    ...
    return (React.createElement(MenuSection, { icon: "fa-solid fa-toolbox", id: "tools-section", title: "Ne İstersiniz?" }, getTools()));
};
const Restaurants = () => {
    const getRestaurants = () => {
        return [{
                desc: "Şehirdeki en iyi burger yerleri",
                id: 1,
                ...
                desc: "Etraftaki en iyi dondurma",
                id: 2,
                ...
                desc: "Bayramda et yemenin tavsiyeleri",
                id: 4,
    ...
    return (React.createElement(MenuSection, { icon: "fa-regular fa-pot-food", id: "restaurants-section", title: "Yemek Siparişi Alın!" }, getRestaurants()));
};
const Movies = () => {
    const getMovies = () => {
        return [{
                desc: "Uzayın büyük bir bölümünü izleyen bazı insanların hikayesi.",
                id: 1,
                ...
                title: "Samanyolu'nun Koruyucuları"
            }, {
                desc: "Bazı insanlar bazı şeyleri bozmak için deliklerini terk eder.",
                id: 2,
                ...
                title: "Delik İnsanlar"
            }, {
                desc: "Kafasında göçük olan bir çocuk, kötü bir adamı durdurmaya çalışır. Ve kötü derken, kazanmada kötüyü kastediyorum.",
                id: 3,
                ...
                desc: "Bazı insanların biraz boşluk için savaştığı uzun bir hikaye. Çünkü yeterince yok.",
                id: 4,
    ...
    return (React.createElement(MenuSection, { icon: "fa-solid fa-camera-movie", id: "movies-section", scrollable: true, title: "Patlamış Mısır Z   amanı!" }, getMovies()));
};
    ...
    return (React.createElement("div", { id: "app-menu" },
        React.createElement("div", { id: "app-menu-content-wrapper" },
            React.createElement("div", { id: "app-menu-content" },
                ...
                React.createElement("a", { id: "youtube-link", className: "clear-button", href: "https://www.youtube.com/channel/UCUhEUfsxwjne42GhNscKa4w?sub_confirmation=1", target: "_blank" },
                    React.createElement("i", { className: "fa-brands fa-youtube" }),
                    React.createElement("span", null, "Eyüp Can Balaban")),
